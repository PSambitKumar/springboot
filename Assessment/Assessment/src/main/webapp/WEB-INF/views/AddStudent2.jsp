...
<body>
		<form:form onsubmit="return validate()" action="AddStudent2" modelAttribute="addstudent2">
		...
		<div class="container">
			...
			<div class="form-group">
			    ...
			    <form:input class="form-control" id="smail" type="email" path="studentemail" placeholder="Type Here.."/>
			</div><form:hidden path = "regno"/>
			
			<div>
				<div class="b1"><button class="btn btn-primary" type="submit" >Update Student</button></div>
