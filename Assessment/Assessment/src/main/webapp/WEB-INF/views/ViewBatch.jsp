...
<body>
	<h1 align="center">List of Batch</h1>
	<table border = "0" align="center" id="mytable" class="table table-striped table-bordered">
		...
		<tbody>
			...
			<tr>
				...
				<td>${e.enddate}</td>
				<td>
					<a href = "${pageContext.request.contextPath}/edit2/${e.batchid}"><span class="glyphicon glyphicon-edit"></span></a>
					|
					<a href = "${pageContext.request.contextPath}/delete/${e.batchid}"><span class="glyphicon glyphicon-trash"></span></a>
				</td>
